...
print golden_ratio_root_iteration()
print golden_ratio_fractional_iteration()
print golden_ratio_babylonian_iteration()
print golden_ration_fibonacci_iteration()